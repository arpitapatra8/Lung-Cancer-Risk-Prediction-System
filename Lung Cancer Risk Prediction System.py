...
loaded_model = pickle.load(open('D:/1.12.23/Documents/Essays and Project/Final Year Project/Web App/prediction_model.sav', 'rb'))
...
def main():
    ...
    local_css('D:/1.12.23/Documents/Essays and Project/Final Year Project/Web App/styles.css')  # Replace 'styles.css' with the file name containing your CSS styles
